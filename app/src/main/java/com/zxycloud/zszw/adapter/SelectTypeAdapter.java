...
public class SelectTypeAdapter extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    public void setDataBeans(List<ResultTypeMenuBean.DataBean> dataBeans) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerViewHolder recyclerViewHolder, final int i) {
        recyclerViewHolder.setText(R.id.tv_point_entry, CommonUtils.string().getString(dataBeans.get(i).getPatrolItemTypeName()));
