...
public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_service_menu, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        if (!mBooleanArray.get(position)) {
            ...
            holder.itemView.setBackgroundResource(R.color.colorLine);
            holder.tvName.setTextColor(mContext.getResources().getColor(R.color.colorItem));
        } else {
