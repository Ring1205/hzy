...
public class RiskDataReportFragment extends BaseBackFragment {
    ...
    public static RiskDataReportFragment newInstance(String reportInfo) {
        Bundle args = new Bundle();
        args.putString("reportInfo", reportInfo);
        RiskDataReportFragment fragment = new RiskDataReportFragment();
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        riskReportBean = new Gson().fromJson(getArguments().getString("reportInfo"), RequestRiskReportBean.class);
        ...
        riskDescription.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (riskDescription.getText().toString().length() >= 50) {
    ...
    private void submitRisk() {
        ...
        if (riskReportBean.canReport()) {
            netUtils.request(new NetUtils.NetRequestCallBack() {
                @Override
                public void success(String action, BaseBean baseBean, Object tag) {
                    if (baseBean.isSuccessful()) {
                        ReportRiskListFragment.isUpdate = true;
                        backEndTag(CloseType.RISK_REPORT_TAG);
                    }
            ...
            }, true, new ApiRequest<>(NetBean.actionAddRiskRecord, BaseBean.class)
                    .setRequestType(ApiRequest.REQUEST_TYPE_POST)
                                    ...
                                    public void initPopup(CustomPopupWindows.PopupHolder holder) {
                                        holder.setClickListener(R.id.popup_capture, new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                PermissionUtils.setRequestPermissions(RiskDataReportFragment.this, new PermissionUtils.PermissionGrant() {
                                                    @Override
                                                    ...
                                                    public void onRequestResult(List<String> deniedPermission) {
                                                        if (CommonUtils.judgeListNull(deniedPermission) == 0) {
                                                            imgPath = CommonUtils.openCamera(RiskDataReportFragment.this, PHOTO);
