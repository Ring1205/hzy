...
public class AlertDetailFragment extends BaseBackFragment implements View.OnClickListener {
    ...
    private TextView alertDetailFloorPlace, alertDetailVideo;
    private boolean isFire;

    public static AlertDetailFragment newInstance(@AlertShowType.ShowType int showType, int stateCode, String alertString) {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        showType = arguments.getInt("showType");
        alertString = arguments.getString("alertString");
        stateCode = arguments.getInt("stateCode");
        ...
        alertDetailFloorPlace = findViewById(R.id.alert_detail_floor_place);
        alertDetailVideo = findViewById(R.id.alert_detail_video);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.alert_detail_floor_place:
                if (alarmBean.getIsHasLayerPoint() == 0) {
...
//        aMap.setOnInfoWindowClickListener(this);// 设置点击infoWindow事件监听器
    ...
    private void getDetail() {
        netUtils.request(new NetUtils.NetRequestCallBack<ResultAlertBean>() {
            @Override
        ...
        }, true, new ApiRequest<>(NetBean.actionGetAlertDetail, ResultAlertBean.class)
                .setRequestParams("recordId", showType == AlertShowType.ALERT_HAPPENING ? alarmBean.getRecordId() : alertString));
    }
