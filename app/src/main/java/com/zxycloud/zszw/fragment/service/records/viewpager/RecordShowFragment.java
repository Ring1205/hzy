...
public class RecordShowFragment extends BaseBackFragment {
    ...
    public static RecordShowFragment newInstance(@FromType int fromType, @StateCode int stateCode) {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        recordRv.initAdapter(R.layout.base_item, recordCallBack).setLayoutManager();
