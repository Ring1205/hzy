...
public class ProjectBean extends BaseDataBean {
    public static final String ALL_PROJECT_ID = "ALL_PROJECT_ID";
    /**
     * projectId :
     * projectName :
     * type : 1
    ...
    public ProjectBean(int i) {
        this.projectName = "My name is 单位" + i;
        projectId = i + "";
    }

    public ProjectBean(Context context, String projectId) {
        this.projectId = projectId;
        projectName = CommonUtils.string().getString(context, R.string.all_project);
    }
