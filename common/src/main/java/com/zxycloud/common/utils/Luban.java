...
public class Luban {
    ...
    private File thirdCompress(@NonNull File file) {
        ...
        String thumb = mCacheDir.getAbsolutePath() + File.separator +
                (TextUtils.isEmpty(filename) ? System.currentTimeMillis() + fileName.substring(0, fileName.lastIndexOf(".")) + ".png" : filename);
    ...
    private File firstCompress(@NonNull File file) {
        ...
        String fileName = file.getName();
        String filePath = file.getAbsolutePath();
        String thumbFilePath = mCacheDir.getAbsolutePath() + File.separator + (TextUtils.isEmpty(filename) ? System.currentTimeMillis() + fileName.substring(0, fileName.lastIndexOf(".")) + ".png" : filename);
