...
import static com.zxycloud.common.widget.cameralibrary.JCameraView.BUTTON_STATE_BOTH;
import static com.zxycloud.common.widget.cameralibrary.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.zxycloud.common.widget.cameralibrary.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    public CaptureButton(Context context, int size) {
        ...
        CommonUtils.log().i("CaptureButtom start");
        duration = 10 * 1000;              //默认最长录制时间为10s
        CommonUtils.log().i("CaptureButtom end");
