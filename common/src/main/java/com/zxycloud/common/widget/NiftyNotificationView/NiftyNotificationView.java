...
import com.zxycloud.common.widget.MargueeTextView;
...
public class NiftyNotificationView {
        ...
        if (null != onClickListener) {
            notifyView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    onClickListener.onClick(v, configuration.tag);
                }
            });
        }
    ...
    private RelativeLayout initializeContentView() {
        ...
        Configuration.Builder.Margin margin = this.configuration.margin;
        if (null != margin && margin.isSet()) {
            lp.setMargins(margin.getMarginStart(), margin.getMarginTop(), margin.getMarginEnd(), margin.getMarginBottom());
        }
        ...
        Configuration.Builder.Margin textMargin = this.configuration.textMargin;
        if (null != textMargin && textMargin.isSet()) {
            textParams.setMargins(textMargin.getMarginStart(), textMargin.getMarginTop(), textMargin.getMarginEnd(), textMargin.getMarginBottom());
        }
    ...
    private TextView initializeTextView() {
        ...
        MargueeTextView text = new MargueeTextView(this.activity);
...
//        text.setEllipsize(TextUtils.TruncateAt.END);
        ...
        text.setTextColor(activity.getResources().getColor(this.configuration.textColor));
        text.setBackgroundResource(this.configuration.backgroundRes);
...
//        image.setMaxHeight(maxValue);
        ...
        image.setBackgroundResource(this.configuration.iconBackgroundRes);
    ...
    public NiftyNotificationView setOnClickListener(OnClickListener onClickListener) {
