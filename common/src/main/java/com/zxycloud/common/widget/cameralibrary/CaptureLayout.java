...
import com.zxycloud.common.widget.cameralibrary.listener.ReturnListener;
...
//                resetCaptureLayout();
        ...
        txt_tip.setText(R.string.long_press_camera);
    ...
    public void setTextWithAnimation(int tip) {
        txt_tip.setText(tip);
