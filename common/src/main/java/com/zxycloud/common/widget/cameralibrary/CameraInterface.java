...
import com.zxycloud.common.widget.cameralibrary.util.AngleUtil;
import com.zxycloud.common.widget.cameralibrary.util.CameraParamUtil;
import com.zxycloud.common.widget.cameralibrary.util.CheckPermission;
import com.zxycloud.common.widget.cameralibrary.util.DeviceUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    @SuppressWarnings("ResultOfMethodCallIgnored")
    void setVideoFileName(String videoFileName) {
        ...
        if (! file.exists()) {
            try {
                ...
                e.printStackTrace();
                Log.e("CameraInterface", e.getMessage());
            }
        }
    }
    ...
    public void setZoom(float zoom, int type) {
        ...
        switch (type) {
            ...
            case TYPE_CAPTURE:
                ...
                CommonUtils.log().i("setZoom = " + nowScaleRate);
                break;
        }
...
//        mCamera = Camera.open();
    ...
    public void doStartPreview(SurfaceHolder holder, float screenProp) {
        if (isPreviewing) {
            CommonUtils.log().i("doStartPreview isPreviewing");
        }
...
//        }
        ...
        if (TextUtils.isEmpty(videoFileName)) {
            ...
            videoFileAbsPath = videoFileName;
        }
