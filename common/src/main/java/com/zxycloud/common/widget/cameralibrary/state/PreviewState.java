package com.zxycloud.common.widget.cameralibrary.state;
...
import com.zxycloud.common.widget.cameralibrary.CameraInterface;
...
class PreviewState implements State {
    ...
    public void foucs(float x, float y, CameraInterface.FocusCallback callback) {
        CommonUtils.log().i("preview state foucs");
    ...
    public void cancle(SurfaceHolder holder, float screenProp) {
        CommonUtils.log().i("浏览状态下,没有 cancle 事件");
    }

    @Override
    public void confirm() {
        CommonUtils.log().i("浏览状态下,没有 confirm 事件");
    }

    @Override
    public void zoom(float zoom, int type) {
        CommonUtils.log().i(TAG, "zoom");
