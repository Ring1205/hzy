...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public RecyclerViewHolder setTextWithLeftDrawables(@IdRes int viewId, @DrawableRes int left, String string) {
        TextView view = getView(viewId);
        view.setText(CommonUtils.string().getString(string));
