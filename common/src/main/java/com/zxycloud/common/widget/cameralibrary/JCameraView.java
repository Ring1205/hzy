package com.zxycloud.common.widget.cameralibrary;
...
import com.zxycloud.common.widget.cameralibrary.listener.CaptureListener;
...
import com.zxycloud.common.widget.cameralibrary.listener.TypeListener;
import com.zxycloud.common.widget.cameralibrary.state.CameraMachine;
import com.zxycloud.common.widget.cameralibrary.util.FileUtil;
import com.zxycloud.common.widget.cameralibrary.util.ScreenUtils;
import com.zxycloud.common.widget.cameralibrary.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    private void initData() {
        ...
        CommonUtils.log().i("zoom = " + zoomGradient);
    ...
    private void initView() {
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureListener() {
            ...
            public void recordShort(final long time) {
                mCaptureLayout.setTextWithAnimation(R.string.time_is_too_short);
...
//        });
    ...
    public void onResume() {
        CommonUtils.log().i("JCameraView onResume");
    ...
    //生命周期onPause
    public void onPause() {
        CommonUtils.log().i("JCameraView onPause");
        stopVideo();
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        CommonUtils.log().i("JCameraView SurfaceCreated");
        new Thread() {
            @Override
            public void run() {
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        CommonUtils.log().i("JCameraView SurfaceDestroyed");
    ...
    public void setVideoFileName(String path) {
        CameraInterface.getInstance().setVideoFileName(path);
    }
    ...
    public void startPreviewCallback() {
        CommonUtils.log().i("startPreviewCallback");
