...
public class PhotoGridAdapter extends SelectableAdapter<PhotoGridAdapter.PhotoViewHolder> {
    ...
    public PhotoGridAdapter(Context context, RequestManager requestManager, List<PhotoDirectory> photoDirectories, ArrayList<String> orginalPhotos, int colNum, OnSelectChangeListener listener) {
            ...
            holder.vSelected.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (onItemCheckListener != null) {
                        isEnable = onItemCheckListener.onItemCheck(OnItemCheckListener.PhotoGridAdapter, pos, photo,
