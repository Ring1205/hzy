...
public class ImagePagerFragment extends Fragment {
    ...
    public static ImagePagerFragment newInstance(List<String> paths, List<String> selectPaths, int currentItem) {

        ImagePagerFragment f = new ImagePagerFragment();

        Bundle args = new Bundle();
        args.putStringArray(ARG_PATH, paths.toArray(new String[paths.size()]));
        args.putStringArray(ARG_SELECT_PATH, selectPaths.toArray(new String[selectPaths.size()]));
    ...
    public static ImagePagerFragment newInstance(List<String> paths, List<String> selectPaths, int currentItem, int[] screenLocation, int thumbnailWidth, int thumbnailHeight) {

        ImagePagerFragment f = newInstance(paths, selectPaths, currentItem);
    ...
    public void setPaths(List<String> paths, int currentItem) {
        this.paths.clear();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            String[] selectPathArr = bundle.getStringArray(ARG_SELECT_PATH);
            paths.clear();
            if (pathArr != null) {
            ...
            selectPaths.clear();
            if (selectPathArr != null) {
                selectPaths = new ArrayList<>(Arrays.asList(selectPathArr));
            }
        ...
        mPagerAdapter = new PhotoPagerAdapter(Glide.with(this), paths, selectPaths);
        mPagerAdapter.setPhotos(photos);
        mPagerAdapter.setOnSelectChangeListener(onSelectChangeListener);
        mPagerAdapter.setOnItemCheckListener(onItemCheckListener);
    }
    ...
    public List<String> getSelectPaths() {
        return mPagerAdapter.getSelectPaths();
    }
