...
public class PhotoPickerFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnSelectChangeListener) {
            listener = (OnSelectChangeListener) context;
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        photoGridAdapter = new PhotoGridAdapter(getActivity(), mGlideRequestManager, directories, originalPhotos, column, listener);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        photoGridAdapter.setOnPhotoClickListener(new OnPhotoClickListener() {
            ...
            public void onClick(View v, int position, boolean showCamera) {
                ...
                List<String> selectPhotos = photoGridAdapter.getSelectedPhotoPaths();

                int[] screenLocation = new int[2];
                v.getLocationOnScreen(screenLocation);
                ImagePagerFragment imagePagerFragment =
                        ImagePagerFragment.newInstance(photos, selectPhotos, index, screenLocation, v.getWidth(),
                                v.getHeight());
                ((PhotoPickerActivity) getActivity()).addImagePagerFragment(imagePagerFragment);
                imagePagerFragment.setPhotos(photoGridAdapter.getCurrentPhotos());
                imagePagerFragment.setOnItemCheckListener(getPhotoGridAdapter().getOnItemCheckListener());
                imagePagerFragment.setOnSelectChangeListener(getPhotoGridAdapter().listener);
            }
        });
    ...
    public void setSelectedPhotoPaths() {
        photoGridAdapter.getSelectedPhotoPaths();
    }
    ...
    public void setSelectedPhotos(List<String> selectPaths) {
        photoGridAdapter.setSelectedPhotos(selectPaths);
    }
}
